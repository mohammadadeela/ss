    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-72 md:h-96 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1607083206869-4c7672e72a8a?w=1920&q=80&fit=crop" alt={t.nav.sales} className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-sm sm:text-base md:text-lg font-light opacity-90 max-w-xl mx-auto" data-testid="text-sales-page-subtitle">{t.categoryPages.salesSubtitle}</p>
        </div>
      </section>
